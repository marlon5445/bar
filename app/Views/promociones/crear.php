...
<div class="page-header">
    <div class="page-header-left">
        ...
        <p class="page-subtitle">Configura un nuevo combo o oferta de productos</p>
    </div>
...
<div class="card card-form-center" style="max-width: 850px;">
    ...
    <form action="<?= site_url('promociones/guardar'); ?>" method="POST" autocomplete="off" class="modern-form" id="formPromocion">
        <?= csrf_field(); ?>

        <div class="form-group">
            <label for="nombre" class="form-label">Nombre de la Promoción <span class="text-danger">*</span></label>
            <input type="text" id="nombre" name="nombre" value="<?= old('nombre'); ?>" required maxlength="100" class="form-input-custom" placeholder="Ej: 3 Jarras S/20">
        </div>

        <div class="form-group">
            <label for="precio" class="form-label">Precio Promocional (S/) <span class="text-danger">*</span></label>
            <input type="number" id="precio" name="precio" step="0.01" value="<?= old('precio'); ?>" required class="form-input-custom" placeholder="0.00" min="0.01">
        </div>

        <div class="form-group">
            <label for="descripcion" class="form-label">Descripción <span class="text-muted">(Opcional)</span></label>
            <textarea id="descripcion" name="descripcion" class="form-input-custom textarea-custom" placeholder="Detalles de la promoción..."><?= old('descripcion'); ?></textarea>
        </div>
...
<!-- MODAL DE ERROR (Para validaciones frontend) -->
