...
<div class="card card-form-center">
    ...
    <form action="<?= site_url('clientes/guardar'); ?>" method="POST" autocomplete="off" class="modern-form">
        <?= csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" id="telefono" name="telefono" value="<?= old('telefono'); ?>" class="form-input-custom" placeholder="Ej: 987654321">
        </div>

        <div class="form-group">
            <label for="limite_credito" class="form-label">Límite de Crédito (S/)</label>
            <input type="number" id="limite_credito" name="limite_credito" value="<?= old('limite_credito', '0.00'); ?>" step="0.01" min="0" required class="form-input-custom" placeholder="0.00">
        </div>
